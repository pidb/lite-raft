...
mod protos {
    ...
    impl ::protobuf::Clear for RaftGroupDesc {
        fn clear(&mut self) {
            ::prost::Message::clear(self);
        }
    }

    impl ::protobuf::Message for RaftGroupDesc {
        fn compute_size(&self) -> u32 {
            ::prost::Message::encoded_len(self) as u32
        }
        ...
        fn default_instance() -> &'static RaftGroupDesc {
            ::lazy_static::lazy_static! {
                static ref INSTANCE: RaftGroupDesc = RaftGroupDesc::default();
            }
            &*INSTANCE
        }
